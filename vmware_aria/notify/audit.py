"""Audit logging for all write operations in VMware Aria skill."""
...
class AuditLogger:
    ...
    Logs to ``~/.vmware-aria/audit.log`` by default. Each entry records
    *what* was done, *where*, *before/after* state, and *who* initiated it.
    ...
    def log(
        ...
        *,
        ...
        """Append a single audit entry to the log file and emit to logger."""
        entry: dict[str, Any] = {
